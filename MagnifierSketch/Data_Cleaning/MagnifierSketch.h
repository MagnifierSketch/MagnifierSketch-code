...
template<typename ID_TYPE, typename DATA_TYPE>
class MagnifierSketchSketch {
public:
	MagnifierSketchSketch() {}
	MagnifierSketchSketch(uint32_t memory, uint32_t thre, double tower, uint32_t mm, uint32_t dd, double lambda, std::vector<int> &len) {
