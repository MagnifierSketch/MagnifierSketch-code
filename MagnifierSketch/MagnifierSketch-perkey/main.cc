...
int main(int argc, const char** argv) {
	freopen("data_MagnifierSketch.out", "w", stdout);
    ...
    for (int memory = 900; memory <= 1500; memory += 200)
     {
		...
		++cnt;
        cur = benchmark.Run(0.99, 0.1, 40, memory, 11, 7, 5.80, v);
        res[cnt] = cur;
    }
    ...
    for (double w = 0.10; w < 0.95; w += 0.10)
    {
        ...
        v.push_back(15); v.push_back(2);v.push_back(2);v.push_back(2);
		++cnt;
        cur = benchmark2.Run(w, 0.1, 40, 80, 11, 7, 5.80, v);
        res[cnt] = cur;
    ...
    for (double w = 0.10; w < 0.95; w += 0.10)
    {
        ...
        v.push_back(15); v.push_back(2);v.push_back(2);v.push_back(2);
		++cnt;
        cur = benchmark3.Run(w, 0.1, 40, 80, 11, 7, 5.80, v);
        res[cnt] = cur;
