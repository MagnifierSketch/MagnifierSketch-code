...
public:
    ...
    std::pair<std::pair<double, double>, double> Run(uint32_t memory, double eps, double quantile, double theta)  
    {
        ...
        double throughput1 = double(running_length) / totaltime;
        ...
        double totaltime2=(double)(total)/CLOCKS_PER_SEC;
        ...
        return std::make_pair(std::make_pair(throughput1, throughput2), error / num);
...
public:
	...
	std::pair<std::pair<double, double>, double> Run(uint32_t memory, double eps, double quantile, double theta) 
    {
        uint32_t running_length = 14000000;
        ...
        //std::cout <<"insert time taken: "<<totaltime<<" seconds"<< std::endl;
        double throughput1 = double((int)v.size()) / totaltime1;
        //std::cout <<"insert throughput: "<<std::fixed<<std::setprecision(4)<< throughput <<" item/s"<< std::endl;
        ...
        double totaltime2=(double)(total1)/CLOCKS_PER_SEC;
        double throughput2 = double(num) / totaltime2;
        /*totaltime=(double)(total)/CLOCKS_PER_SEC;
        std::cout <<"query time taken: "<<totaltime<<" seconds"<< std::endl;
        throughput = double(num) / totaltime;
